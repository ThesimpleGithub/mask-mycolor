"use strict";(self.webpackChunk_N_E=self.webpackChunk_N_E||[]).push([[132],{5156:function(e,t,n){n.d(t,{Tt:function(){return $},Vm:function(){return l},kW:function(){return v}});var r=n(5239),i=n(9610),o=n(8110);/**
 * @license
...
`}(t,n);case 3:return function(t,n){let i=t.shapeInfo.logicalShape,o=t.name,a="get"+o.charAt(0).toUpperCase()+o.slice(1),l=i[1]*i[2],c=i[2],{newShape:u,keptDims:p}=r.D5U.squeezeShape(i);if(u.length<i.length){let x=f(t,u);return`
  ...
  `}(t);default:throw Error(`${i.length}-D input sampling is not yet supported`)}}(e,o);let c=e.shapeInfo.logicalShape,u=t.logicalShape;return c.length<=u.length&&(n?l+=function(e,t){let n;let i=e.name,o=i.charAt(0).toUpperCase()+i.slice(1),l=e.shapeInfo.logicalShape.length,c=t.logicalShape.length,u=a(e.shapeInfo.logicalShape,t.logicalShape),p=v(c),x=c-l,h=["x","y","z","w","u","v"];n=0===l?"":c<2&&u.length>=1?"coords = 0;":u.map(e=>`coords.${h[e+x]} = 0;`).join("\n");let s="";s=c<2&&l>0?"coords":e.shapeInfo.logicalShape.map((e,t)=>`coords.${h[t+x]}`).join(", ");let d="return outputValue;",$=r.D5U.sizeFromShape(e.shapeInfo.logicalShape),f=1===$,S=r.D5U.sizeFromShape(t.logicalShape),C=1===S;if(1!==l||f||C){if(f&&!C)d=1===c?`
      ...
      `;else if(u.length){let T=l-2,m=l-1;u.indexOf(T)>-1&&u.indexOf(m)>-1?d="return vec4(outputValue.x);":u.indexOf(T)>-1?d="return vec4(outputValue.x, outputValue.y, outputValue.x, outputValue.y);":u.indexOf(m)>-1&&(d="return vec4(outputValue.xx, outputValue.zz);")}}else d=`
